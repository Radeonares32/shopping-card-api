...
export const deleteUserProductBasket = app.get('/deleteUserProductBasket',ProductControllers.deleteUserProductBasket)
export const deleteAdminProductBasket = app.get('/deleteAdminProductBasket',ProductControllers.deleteAdminProductBasket)
export const deleteProductBasket = app.get('/deleteProductBasket',ProductControllers.deleteProductBasket)